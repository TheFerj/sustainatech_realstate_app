...
import { TenantClassificationHandler } from "./tenantClassificationHandler";
...
export default async function TeanantClassificationPage() {
  ...
  const userAppointments = await getUserWall();
  return (
    <>
    <div className="columns-1">
        tenant classification list
        <TenantClassificationHandler user_Id={user_Id} email={email} userPosts={userAppointments}/>
    </div>
    </>

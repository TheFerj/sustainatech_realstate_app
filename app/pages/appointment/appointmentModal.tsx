...
import { PostAppointment } from "./appointmentForm";
...
const AppointmentModal = ({ id, email }: AppointmentModalProps) => {
      ...
      {isModalOpen && (
        ...
        >
          <div className="relative bg-white rounded-lg shadow p-6">
            ...
            <PostAppointment id={id} email={email} /> {/* Pass id and email as props */}
